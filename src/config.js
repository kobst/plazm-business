exports.getMessage = () => {
  return {
    ...
    Login_Mess_Consumer: 'Login to start working on your Consumer profile page',
    Remember: 'Remember me',
    No_Account: 'Don\'t have an account? ',
    Forgot: 'Forgot password?',
    Reg: 'Register to Get Started',
    New_Reg: 'Start working on your business profile page',
    New_Reg_Consumer: 'Start working on your consumer profile page',
    ...
    Reg_Message: `By clicking register, I represent I have read, understand, 
      and agree to the Postmates Privacy Policy and Terms of Service. 
      This site is protected bt reCAPTCHA and google Privacy Policy and Terms of Service apply.`,
    ...
    Submit: 'Submit',
    Email_Msg:
      'Enter the email address you registered with and we\'ll send you instruction to Reset your password',
    Email_Err: 'This Email is not Registered.',
    Busi_Err:
      `The business you are trying to add is associated with an account. 
      If you are the owner of the business and would like to reclaim 
      the business for yourself, please send an email to support@metagon.com along with Proof`,
    phone_Err:
    ...
    pass_length:
      'Password does not confirm to policy: Password not long enough',
