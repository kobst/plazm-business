...
function PostModalBox({ isOpen, closeModal, value, place, newComment }) {
  ...
  const getDate = (value) => {
    ...
    const time = `${ConvertNumberToTwoDigitString(
      date.getHours()
    )}:${ConvertNumberToTwoDigitString(date.getMinutes())}, ${date
      .toLocaleString()
  ...
  return (
    <div>
      ...
      >
        <div
          style={
            image.length > 0 ? { maxWidth: '1000px' } : { maxWidth: '600px' }
          }
          ...
          <div className="postOuter">
            ...
            <div className="postDetails">
              <div className="messageSec">
                ...
                <div className="text">
                  <h2>
                    {value && value.name ? value.name : place.company_name}
                  </h2>
