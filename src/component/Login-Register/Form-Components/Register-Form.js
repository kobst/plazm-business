        ...
        <>
            {verified ? (<form>
                    ...
                    <>
                        ...
                        {type.includes('business')?<Link to='/business/login' className="link-btn"><strong>Sign In</strong></Link>:<Link to='/customer/login' className="link-btn"><strong>Sign In</strong></Link>}
