    ...
    <DescriptionViewItem>
      <UserMessageContent>
        ...
        <FeedContainer>
          <InnerListBanner>
            ...
            <ListNameWrap>
              ...
              <ListInfo>
                ...
                <span>|</span>
                <ListAuthorName>
                  Added on Apr 15, 2021, 5:40pm EDT
                </ListAuthorName>
              </ListInfo>
            </ListNameWrap>
          </InnerListBanner>
          ...
          <FeedDescription>
            A bright, cheery spot on the Upper West Side that’s been around
            since 2015, Boule & Cherie currently has an outdoor patio set up
            with ample WiFi access. The coffee comes from Stumptown, and the
            food goes beyond the typical pastry selection here, with quiches and
            frittatas for a legitimate working breakfast or lunch. It’s open
            from 7:30 a.m. to 4 p.m. daily <br />
            <br />
            ...
            lunch. At the company’s Long Island City location, a selection of
            pastries is available all day while the kitchen is open from 9 a.m.
            to 2:45 p.m., serving breakfast burritos, wraps, and sandwiches.
            Outdoor seating is available and equipped with Wi-Fi. Partners also
