      ...
      >
        <div className="ModalHeader">
          ...
          <Button onClick={() => onCancel()} type="submit"
            className="btn btn-primary cancel"><img src={crossIocn} alt="Delete" /></Button>
        ...
        <div className="ContentModal">
          <FormGroup>
            ...
            <Input type="text" className={titleError?'active':null}
              id='title' value={title} onChange={(e) => handleChange(e)} />
          </FormGroup>
          <FormGroup>
          ...
          {!editValue ?
            <>
              <div className="modalButton">
                <Button disabled={saveDisable} onClick={() => addEvent()}
