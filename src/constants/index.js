export default {
  ...
  MINIMUM_EVENT_TITLE_LENGTH: "minimum length 5 is required.",
  ...
  START_DATE_GREATER_THAN_CURRENT:
    "start date should be greater than current date",
  SEARCH_ERROR: "minimum 4 characters are required",
  NO_BUSINESS_FOUND: "No Results Found",
